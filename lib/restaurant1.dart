...
List<food1> restaurant1 = [
  food1(
      ...
      imageUrl:
          'https://gourmandelle.com/wp-content/uploads/2017/08/vegan-chicken-burger-vegan-cu-pui-la-gratar-720x405.jpg',
      description:
          'Made with whole food ingredients and full of plant based protein this Vegetarian burgers can be served with salad items, such as onions,tomatoes, lettuce or cabbage leaves, cheese,',
      price: 75,
      id: 1),
  food1(
      name: 'Veg Cheese Burger',
      imageUrl:
          'https://d1z88p83zuviay.cloudfront.net/ProductVariantThumbnailImages/b934cb3f-85db-4429-b520-c0349575008b_425x425.jpg',
      description:
